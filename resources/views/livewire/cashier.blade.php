                    ...
                    <div class="col-6 col-lg-4">
                        <div class="card" style="cursor: pointer;" wire:click="addToCart({{ $item->id }})">
                            <div class="card-body p-4">
                                <img src="{{ asset($item->image) }}" class="w-75 d-block mx-auto" alt="Dish 01">
                        ...
                        @foreach ($transaction->details as $item)
                            <div class="row align-items-center g-3 mt-3">
                                <div class="col-3 col-lg-2">
                                    <img src="{{ asset($item->menu->image) }}" alt="" class="rounded-2">
                                </div>
                                ...
                                <div class="col-6 col-lg-3">
                                    <p class="mb-0 text-dark fw-bold text-end">Rp.
                                        {{ number_format($item->menu->price * $item->quantity) }}
                                    </p>
                                </div>
